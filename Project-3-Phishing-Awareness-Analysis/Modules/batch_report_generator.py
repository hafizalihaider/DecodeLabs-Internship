...
# File        : batch_report_generator.py
#
# Description :
# Handles report generation for multiple analyzed emails,
# including separate reports and a combined report.
#
# ============================================================
...
def batch_report_menu(all_report_data):
     ...
     while True:
          ...
          print("=" * 100)
          print()
          print("Do you want to create a report?\n")
          ...
          if choice == "1":
               ...
               # Generate an individual report for every analyzed email.
               ...
               # Generate one report containing all analyzed emails.
...
def generate_combined_report(all_report_data):
     ...
     with open(file_path, "w") as file:
          ...
          # Add each email's filename and complete analysis to the combined report.
